                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" name="last_date" id="end_date" value="@if($employeeDetail->last_date) {{ $employeeDetail->last_date->format('m/d/Y') }} @endif" class="form-control">
                                    </div>
                                </div>
