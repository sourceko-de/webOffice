...
class ManageAllTasksController extends AdminBaseController
{
    ...
    public function data($startDate = null, $endDate = null, $hideCompleted = null, $projectId = null) {
        ...
        $tasks = Task::leftJoin('projects', 'projects.id', '=', 'tasks.project_id')
            ...
            ->select('tasks.id', 'projects.project_name', 'tasks.heading', 'users.name','creator_user.name as created_by','creator_user.image as created_image', 'users.image', 'tasks.due_date', 'taskboard_columns.column_name', 'taskboard_columns.label_color', 'tasks.project_id');
        ...
        return DataTables::of($tasks)
            ...
            ->rawColumns(['column_name', 'action', 'project_name', 'due_date', 'name', 'created_by', 'heading'])
